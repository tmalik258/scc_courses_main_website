...
export function ContactForm() {
  ...
  return (
    <section className="px-6 py-8 md:py-30 bg-sky-frost/80">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            <Button
              type="submit"
              className="bg-aqua-mist hover:bg-aqua-depth text-white w-1/2 py-3 text-lg md:rounded-xs font-medium"
            >
              Send message
            </Button>
          </div>
