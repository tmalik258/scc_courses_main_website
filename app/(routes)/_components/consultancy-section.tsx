...
export function ConsultancySection() {
  return (
    <section className="px-6 py-8 max-sm:py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 sm:mb-12">
          Our Consultancy Firm
        </h2>

        <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-12">
          {/* Company Info */}
          <div className="flex items-center gap-6 sm:mb-6">
            {/* Logo */}
            <div className="w-40 sm:w-56 h-auto flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1 grow w-full flex flex-col items-start">
            ...
            <Button className="bg-aqua-mist hover:bg-aqua-depth text-white px-8 py-3 font-manrope max-sm:self-end">
              Visit Website
            </Button>
          </div>
        </div>
