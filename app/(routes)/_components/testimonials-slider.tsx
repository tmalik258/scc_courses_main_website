...
export function TestimonialSlider() {
  ...
  return (
    <div className="relative">
      ...
      {/* Slider Container */}
      <div className="overflow-hidden pt-2 pb-0 mb-0">
        <div
        ...
        >
          {testimonialsData.map((testimonial) => (
            ...
            >
              <div className="bg-white rounded-md shadow-md shadow-gray-300 px-6 py-8 min-h-[320px] border border-gray-100">
                {/* Stars + Quote Icon */}
                <div className="flex items-center mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5 text-yellow-400 fill-yellow-400 mr-3"
                    />
                  ))}
                  <Quote
                    className="w-6 h-6 ml-auto"
                    style={{ color: "#5CB1D1", fill: "#5CB1D1" }}
                  />
                </div>
