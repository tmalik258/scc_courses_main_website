...
export function LearningProgress({ showJoinButton = false }: LearningProgressProps) {
  return (
    <div className="border-t border-gray-200 pt-4">
      ...
      {showJoinButton && (
        <>
          ...
          {/* Join Course Button */}
          <Button className="w-full bg-sky-400 hover:bg-sky-500 text-white py-3">Join Course</Button>
        </>
      )}
    </div>
  )
