...
export function PaywallContent({ courseId, lessonTitle, onPrevious, onNext }: PaywallContentProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 md:py-16 md:px-8 text-center">
      ...
      <h2 className="md:text-2xl font-bold text-gray-800 mb-4">Ready to Learn More? Get Full Access Today</h2>
      ...
      <Button className="max-md:text-sm bg-aqua-mist hover:bg-aqua-depth text-white px-8 py-3 text-lg md:mb-8 cursor-pointer" onClick={handleBuyNow}>Buy Now</Button>
